...
const LINE_META = {
    sb:  {
        ...
        desc:  'Fast-adapting baseline. Tracks near-term momentum and is the primary input for the short-horizon regime.',
    },
    mb:  {
        color: '#ef4444',
        label: 'MB — Medium Baseline',
        params: 'KAMA · ER=20 · fast=2 · slow=30 · source=HLC/3',
        desc:  'Master trend line. Drives the medium-horizon regime that governs all trade management bands (MRT, MDB).',
    },
    lb:  {
        color: '#f97316',
        label: 'LB — Long Baseline',
        params: 'KAMA · ER=40 · fast=2 · slow=60 · source=HLC/3',
        desc:  'Macro structure line. Very slow to react — only flips on sustained multi-month directional moves.',
    },
    sdb: {
        color: '#22c55e',
        label: 'SDB — Short Deviation Band  (TP1)',
        params: 'Center=SB · +2.0 × ATR(20) · ratchets UP in long regime',
        desc:  'First take-profit target. Ratcheting band anchored to SB.',
    },
    mrt: {
        color: '#475569',
        label: 'MRT — Medium Retracement  (Stop)',
        params: 'Center=MB · −2.25 × ATR(20) · ratchets UP in long regime',
        desc:  'Trailing stop level. Sits 2.25 ATR on the loss side of MB.',
    },
    mdb: {
        color: '#16a34a',
        label: 'MDB — Medium Deviation Band  (TP2)',
        params: 'Center=MB · +4.5 × ATR(20) · ratchets UP in long regime',
        desc:  'Main take-profit target. Exactly 2× the stop distance, giving a built-in 2:1 R:R.',
    },
    lrt: {
        color: '#6b7280',
        label: 'LRT — Long Retracement  (Wide Stop)',
        params: 'Center=LB · −2.25 × ATR(20) · ratchets in long-horizon regime',
        desc:  'Wide trailing stop for long-horizon positions.',
    },
    ldb: {
        color: '#06b6d4',
        label: 'LDB — Long Deviation Band  (Extended Target)',
        params: 'Center=LB · +4.5 × ATR(20) · ratchets in long-horizon regime',
        desc:  'Extended target for multi-month positions.',
    },
};
...
function renderTrendScanTable(data) {
    ...
    const cols = [
        ...
        { key: 'kama10_pct', label: '% vs K10',         title: '% distance from KAMA(10)' },
        { key: 'kama20_pct', label: '% vs K20',         title: '% distance from KAMA(20)' },
        { key: 'kama50_pct', label: '% vs K50',         title: '% distance from KAMA(50)' },
        { key: 'tp2_price',  label: 'TP2 / P',          title: 'MDB (target) ÷ price' },
        { key: 'price_stop', label: 'P / Stop',         title: 'Price ÷ MRT (stop)' },
        { key: 'rr',         label: 'R : R',            title: 'Reward / Risk' },
